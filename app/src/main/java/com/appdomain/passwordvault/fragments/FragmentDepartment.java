...
public class FragmentDepartment extends Fragment implements View.OnClickListener{
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
		...
		heading1.setText(R.string.header_depts_heading1);
		heading2.setText(R.string.header_depts_heading2);
	...
	public void onClick(View view) {
		...
		switch (view.getId()){
			case R.id.fragment_section_fab:
				MainActivity.nextFragment(this, new FragmentDepartmentAdd(), null, false, false);
				break;
		}
	}
}
